...
public final class RangeTest {
    ...
    public final void overlaps() {
        ...
        assertThat("Bounded range overlaps bounded range located right end", boundedRange.overlaps(new Range<Integer>(10, 14)), is(true));
    ...
    public final void dateTest() {
        ...
        Instant st = Instant.parse("2015-10-01T00:00:00.000Z");
//        ISO_LOCAL_DATE_TIME = new DateTimeFormatterBuilder()
//                .append(DateTimeFormatterISO_LOCAL_TIME)
//                .toFormatter(ResolverStyle.STRICT, IsoChronology.INSTANCE);
        System.out.println("mydate = " + new Date(287542800000l));
...
//                .appendLiteral(' ')
        ...
        TemporalAccessor soo = DateTimeFormatter.ISO_LOCAL_DATE_TIME.parse("2015-10-01T00:00:00");

        LocalDateTime tom = LocalDateTime.of(1979, 2, 11, 3, 0, 0);
        Instant uu = Instant.ofEpochMilli(287542800000l);
